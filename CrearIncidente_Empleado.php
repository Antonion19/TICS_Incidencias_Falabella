  ...
  <div class="layout">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <nav class="menu">
          ...
          <a href="CrearIncidente_Empleado.php" class="menu-item active"><i class="fa-solid fa-circle-plus"></i><span class="text">Crear Incidente</span></a>
    ...
    <main class="main">
     <div class="container-fluid px-4 py-4">
        <h1 class="h3 mb-1">Crear Nuevo Incidente</h1>
        <p class="text-muted mb-4">Reporta un problema o solicita ayuda técnica</p>
        <!-- Mensajes -->
        <?php if ($success): ?>
