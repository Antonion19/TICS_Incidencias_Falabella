...
<body>
  ...
  <div class="layout">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            else if ($p === "urgente") $color = "bg-danger";
                                        ?>
    ...
    <div class="modal fade" id="modalSolucion" tabindex="-1">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Solución del Incidente</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <div class="modal-body" id="contenidoSolucion">
                Cargando solución...
            </div>
    ...
    <script>
        $(document).on("click", ".ver-sol-btn", function () {
            const id = $(this).data("id");

            $("#contenidoSolucion").html("Cargando solución...");
            ...
            // Llamar al PHP
            $.get("get_solucion.php", { id: id }, function (data) {
                $("#contenidoSolucion").html(data);
            });
        });
    </script>
